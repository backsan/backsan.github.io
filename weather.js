...
function paintIcon(icon){
    ...
    if(icon === '01d' || icon === '01n' ){ image1.src="http://openweathermap.org/img/wn/01d@2x.png"}
    else if(icon === '02d' || icon === '02n'){ image1.src="http://openweathermap.org/img/wn/02d@2x.png"}
    else if(icon === '03d'|| icon === '03n'){ image1.src="http://openweathermap.org/img/wn/03d@2x.png"}
    else if(icon === '04d'|| icon === '04n'){ image1.src="http://openweathermap.org/img/wn/04d@2x.png"}
    else if(icon === '09d'|| icon === '09n'){ image1.src="http://openweathermap.org/img/wn/09d@2x.png"}
    else if(icon === '10d'|| icon === '10n'){ image1.src="http://openweathermap.org/img/wn/10d@2x.png"}
    else if(icon === '11d'|| icon === '11n'){ image1.src="http://openweathermap.org/img/wn/11d@2x.png"}
    else if(icon === '13d'|| icon === '13n'){ image1.src="http://openweathermap.org/img/wn/13d@2x.png"}
    else if(icon === '10d'|| icon === '10n') { image1.srce = "http://openweathermap.org/img/wn/10d@2x.png"}
